...
class Admin_EmailTemplateController extends Base_Controller_Action {
    ...
    public function editAction() {
        ...
        $form->getElement('name')->setValue(stripslashes($emailTemplate->getName()));
        $form->getElement('body')->setValue(stripslashes($emailTemplate->getBody()));
        $form->getElement('subject')->setValue(stripslashes($emailTemplate->getSubject()));
        $this->view->form = $form;
    }
