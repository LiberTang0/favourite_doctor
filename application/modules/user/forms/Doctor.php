...
class User_Form_Doctor extends Zend_Form {
 ...
 $category=new Application_Model_Category();
        ...
        $this->addElement('text', 'fname', array(
		 ...
		 $this->addElement('file', 'company_icon', array(
            ...
            'decorators' => $this->fileDecorators
        ))->getElement('company_icon')->addValidator('Extension', false, 'jpg,gif,jpeg,png');
 ...
 $this->addElement('text', 'actual_phone', array(
		...
		$this->addElement('MultiCheckbox','payment_options[]',array(
			'multiOptions' => array('Visa' => 'Visa','MasterCard' => 'MasterCard','AmericanExpress' => 'AmericanExpress','Discover' => 'Discover','Check'=>'Check','Cash'=>'Cash','CareCredit'=>'CareCredit'),
		 ...
		 $this->addElement('text', 'insurance_accepted', array(
		  ...
		  $this->addElement('text', 'creditlines', array(
		   ...
		   $this->addElement('text', 'discounts', array(
            'label' => 'Discounts:',
            'required' => false,
            'TABINDEX' => '1',
            'class' => 'form',
