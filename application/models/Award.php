...
class Application_Model_Award {
    ...
    public function getMapper() {
        if (null === $this->_mapper) {
            $this->setMapper(new Application_Model_AwardMapper());
        }
        return $this->_mapper;
    }
    ...
    public function getAwards($where=null, $option=null) {
        $obj=new Application_Model_Award();
        $entries=$obj->fetchAll($where, "award ASC");
        $arrCountry=array();
        if(!is_null($option))
            $arrCountry['']=$option;
        
        foreach($entries as $entry) {
            $arrCountry[$entry->getId()]=$entry->getAward();
        }
        return $arrCountry;
    }
}
