...
class Application_Model_DoctorAppointmentCal {
   ...
   public function setSlotTime($slotTime) {
        $this->_slotTime = (string) $slotTime;
        return $this;
    }
   ...
   public function setSlotDate($slotDate) {
    ...
    public function getMapper() {
        if (null === $this->_mapper) {
            $this->setMapper(new Application_Model_DoctorAppointmentCalMapper());
        }
        return $this->_mapper;
    }
    ...
    private function setModel($row) {
        $model=new Application_Model_DoctorAppointmentCal();
        $model->setDoctorId($row->doctor_id)
                ->setSlotTime($row->slot_time)
